  ...
  group('accepts', () {
    group('Accept header', () {
      ...
      test('matches shorthand type', () {
        final ctx = TestContext.get('/', headers: {'accept': 'text/html'});
      ...
      test('returns default when no match', () {
        final ctx = TestContext.get('/', headers: {'accept': 'image/png'});
      ...
      test('handles wildcard */*', () {
        final ctx = TestContext.get('/', headers: {'accept': '*/*'});
      ...
      test('handles partial wildcard text/*', () {
        final ctx = TestContext.get('/', headers: {'accept': 'text/*'});
    ...
    group('Accept-Language header', () {
      ...
      test('respects quality values', () {
        final ctx = TestContext.get(
          '/',
          headers: {'accept-language': 'en;q=0.8, ja;q=0.9, zh;q=0.7'},
        );
      ...
      test('returns default when no match', () {
        final ctx = TestContext.get('/', headers: {'accept-language': 'fr,de'});
      ...
      test('handles wildcard', () {
        final ctx = TestContext.get('/', headers: {'accept-language': '*'});
    ...
    group('Accept-Encoding header', () {
      ...
      test('returns default when no match', () {
        final ctx = TestContext.get('/', headers: {'accept-encoding': 'br'});
    ...
    group('edge cases', () {
      ...
      test('handles malformed quality value', () {
        final ctx = TestContext.get(
          '/',
          headers: {'accept': 'application/json;q=invalid'},
        );
