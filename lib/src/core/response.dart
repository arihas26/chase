...
class Response {
  ...
  const Response.accepted([Object? body, Map<String, String> headers = const {}])
  ...
  /// ```
  const Response.badRequest([Object? body, Map<String, String> headers = const {}])
  ...
  /// ```
  const Response.unauthorized([Object? body, Map<String, String> headers = const {}])
      : this(HttpStatus.unauthorized, body: body, headers: headers);

  /// Creates a 403 Forbidden response.
  const Response.forbidden([Object? body, Map<String, String> headers = const {}])
  ...
  /// ```
  const Response.notFound([Object? body, Map<String, String> headers = const {}])
      : this(HttpStatus.notFound, body: body, headers: headers);

  /// Creates a 405 Method Not Allowed response.
  const Response.methodNotAllowed([Object? body, Map<String, String> headers = const {}])
      : this(HttpStatus.methodNotAllowed, body: body, headers: headers);

  /// Creates a 409 Conflict response.
  const Response.conflict([Object? body, Map<String, String> headers = const {}])
      : this(HttpStatus.conflict, body: body, headers: headers);

  /// Creates a 422 Unprocessable Entity response.
  const Response.unprocessableEntity([Object? body, Map<String, String> headers = const {}])
      : this(HttpStatus.unprocessableEntity, body: body, headers: headers);

  /// Creates a 429 Too Many Requests response.
  const Response.tooManyRequests([Object? body, Map<String, String> headers = const {}])
  ...
  /// ```
  const Response.internalServerError([Object? body, Map<String, String> headers = const {}])
      : this(HttpStatus.internalServerError, body: body, headers: headers);

  /// Creates a 502 Bad Gateway response.
  const Response.badGateway([Object? body, Map<String, String> headers = const {}])
      : this(HttpStatus.badGateway, body: body, headers: headers);

  /// Creates a 503 Service Unavailable response.
  const Response.serviceUnavailable([Object? body, Map<String, String> headers = const {}])
